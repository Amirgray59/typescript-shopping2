...
export const orderRoute = (server, options, done) => {
    ...
    server.post('/order', orderAdd, async (req, res) => {
        try {
            const all = req.body;
    ...
    server.get('/order/:id', orderSingle, async (req, res) => {
    ...
    server.delete('/order/:id', orderDelete, async (req, res) => {
        try {
            const id = req.params.id;
    ...
    server.put('/order/:id/:status', orderUpdate, async (req, res) => {
        try {
